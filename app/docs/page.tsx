    ...
    <div className="grid grid-rows-[10px_1fr_10px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="ai-search" className="text-lg">
            Ask Gemma:
          </label>
          <textarea
            id="ai-search"
            ...
            className="cursor-pointer p-2 w-160 h-40 rounded-md text-black bg-gray-50 border border-amber-400 hover:border-blue-500"
          ></textarea>
        </div>
